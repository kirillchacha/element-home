...
***************************************************************************** */
        ...
        window.addEventListener("load", (function() {
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState === XMLHttpRequest.DONE && 200 !== xhr.status) window.location.href = "404.html";
            };
            xhr.send();
        }));
        function initMap() {
            let pos = {
                lat: 46.74621283507915,
                lng: 33.36135315844647
            };
            let opt = {
                center: pos,
                zoom: 12,
            ...
            new google.maps.Marker({
                position: pos,
                map: myMaps,
                title: "Місце знаходження меблів"
            });
        }
